__author__ = 'Chase Dudas'
__url__ = 'http://'

HELP_MESSAGE = """Script: ~~~.py
...
# in older opencv these flags are implemented as
# cv2.cv.CV_CAP_PROP_POS_FRAMES and
...
try:
    ...
    VIDEO_PATH = r'd:\Donaldson Lab\Current Work\Covariation of Movement\Similar Motion\similar_motion.avi'
